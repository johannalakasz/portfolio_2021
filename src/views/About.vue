<template>
  ...
  <div id="zine-container">
    <iframe src="https://cdn.flipsnack.com/widget/v2/widget.html?hash=zkaza0qjiq" width="30%" height="500vh" seamless="seamless" scrolling="no" frameBorder="0" allowFullScreen></iframe>
  </div>
  </div>
</template>
